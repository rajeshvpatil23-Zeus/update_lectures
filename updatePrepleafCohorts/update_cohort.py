"""
update_cohort.py — Prepleaf cohort management updater
Site: https://dashboard-admin.prepleaf.com/iit/cohort-management
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Prepleaf cohort management updater")
